  ...
  return (
    <div>
        ...
        <div className='my-10 flex flex-col justify-centre md:flex-row gap-10 mb-28 text-sm'>
            <img className='w-[360px] md:max-w-[360]' src={assets.contact_image} alt=''/>

            <div className='flex flex-col justify-centre items-start gap-6'>
                <p className='font-semibold text-lg text-gray-600'>Our OFFICE</p>
                <p className='text-gray-500'>545 willms Station <br/>Suite 543, Washington, USA </p>
                <p className='text-gray-500'>Tel: (432) 432-5433<br/> Email : carebridge403@gmil.com</p>
